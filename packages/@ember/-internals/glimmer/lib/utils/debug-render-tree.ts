...
export default class DebugRenderTree<Bucket extends object = object> {
  ...
  private pathNodes = new WeakMap<Reference, InternalPathNode<Bucket>>();
  ...
  createPath(pathRef: Reference, name: string, type: PathNodeType, parentRef: Option<Reference>) {
    // assert(
  ...
  logRenderStackForPath(pathRef: Reference): string {
