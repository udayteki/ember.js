...
export default class CustomComponentManager<ComponentInstance>
  ...
  getSelf({ env, delegate, component }: CustomComponentState<ComponentInstance>): Reference {
    return createRootRef(env, delegate.getContext(component));
  }
